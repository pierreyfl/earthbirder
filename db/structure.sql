...
CREATE TABLE `listings` (
  ...
  `price_for_two_people` decimal(10,0) DEFAULT NULL,
  `price_for_three_people` decimal(10,0) DEFAULT NULL,
  `price_for_four_people` decimal(10,0) DEFAULT NULL,
  `price_for_five_people` decimal(10,0) DEFAULT NULL,
  `price_for_six_people` decimal(10,0) DEFAULT NULL,
  `price_for_seven_people` decimal(10,0) DEFAULT NULL,
  `price_for_eight_people` decimal(10,0) DEFAULT NULL,
  `price_for_single_person_hd` decimal(10,0) DEFAULT NULL,
  `price_for_two_people_hd` decimal(10,0) DEFAULT NULL,
  `price_for_three_people_hd` decimal(10,0) DEFAULT NULL,
  `price_for_four_people_hd` decimal(10,0) DEFAULT NULL,
  `price_for_five_people_hd` decimal(10,0) DEFAULT NULL,
  `price_for_six_people_hd` decimal(10,0) DEFAULT NULL,
  `price_for_seven_people_hd` decimal(10,0) DEFAULT NULL,
  `price_for_eight_people_hd` decimal(10,0) DEFAULT NULL,
  PRIMARY KEY (`id`),
